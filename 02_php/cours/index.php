<?php $title = "Introduction au PHP";
 $H1 = "Introduction au PHP";
 $paragraphe = "PHP, ce sigle est un acronyme récursif Préprocesseur Hypertext PHP(PHP Hypertext Preprocessor). Il s'agit d'un langage de script côté serveur open source utilisé pour le développement web dynamique et peut être intégré dans des codes HTML, notez bien qu'un navigateur ne comprend pas le PHP";
 include_once ("inc/header.inc.php");?>
    ...
    <main class="container-fluid px-5">
        ...
        <div class="col-12 mt-5">  
            ...
            <ul>
                <li>À partir du terminal : après avoir installer PHP sur la machine on peut lances les applications avec la ligne de commande <span>php -S localhost:numéroduport (ex: 8000)</span></li>
                <li>Depuis le navigateur : le dossier de la page ou l'application doit être placé dans le dossier laragon > www (puisque qu'on utilise le logiciel xampp afin d'avoir un serveur en local) en suite via l'url il faut chercher la page : <span>localhost/nomdudossier</span> </li>
