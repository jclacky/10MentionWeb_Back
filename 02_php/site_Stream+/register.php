...
?>
<main style="background:url(assets/img/stream+film-2020.jpg) no-repeat; background-size: cover; background-attachment: fixed;" class="w-5">
   
   <div class="w-75 m-auto kl p-5 " style="background: rgba(20, 20, 20, 0.9);">
