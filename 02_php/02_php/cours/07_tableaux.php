<?php 
 $H1 = "Les tableaux en PHP";
 $paragraphe = "En PHP, les tableaux sont utilisés pour stocker et gérer des collections de données. Ils sont créés à l'aide de crochets ([]) et peuvent contenir des valeurs de différents types (entiers, chaînes de caractères, booléens, tableaux imbriqués, etc.).";
    ...
    <main class="container px-5 border">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-5 mt-5">
                ...
                <p>La deuxième façon pour déclarer un tabmeau c'est en utilisant la syntaxe courte avec les crochets <span>[]</span>: <br>
                    <code>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <ul>
                    <li> Pour afficher une valeutr du tableau on écrit son indice dans paire de crochets après le nom du tableau</li>
        ...
        <div class="col-sm-12 col-md-6">
                ...
                <p>Le tableau peut-être créé manuellement, élément par élément. Dans ce cas, les indexs sont "placés à la mains". Il n'est pas obligatoire de commencer à l'index zéro. Les indexs peuvent être des entiers non consécutifs</p>
                <?php
                    $tab1 [2]= 'Orange';
                    $tab1 [10]= 'Magenta';
                    $tab1 [14]= 'Noir';
